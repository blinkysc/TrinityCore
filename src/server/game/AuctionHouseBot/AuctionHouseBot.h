...
enum AuctionBotConfigUInt32Values
{
    ...
    CONFIG_AHBOT_BUYER_MAX_PRICE_RATIO,
    CONFIG_AHBOT_BUYER_GOOD_DEAL_THRESHOLD,
    ...
    // Drop tier list weights (how often items from each tier appear)
    CONFIG_AHBOT_TIER_WEIGHT_50_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_10_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_5_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_2_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_1_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_5_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_2_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_1_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_05_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_02_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_01_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_0_005_PERCENT,
    CONFIG_AHBOT_TIER_WEIGHT_NO_DROP,

    // === NEW: Pricing configs ===
    CONFIG_AHBOT_PRICING_VENDOR_FLOOR_PERCENT,
    CONFIG_AHBOT_PRICING_MAX_BUYOUT,

    // Category minimum prices (copper)
    CONFIG_AHBOT_PRICING_MIN_CONSUMABLE,
    CONFIG_AHBOT_PRICING_MIN_CONTAINER,
    CONFIG_AHBOT_PRICING_MIN_WEAPON,
    CONFIG_AHBOT_PRICING_MIN_GEM,
    CONFIG_AHBOT_PRICING_MIN_ARMOR,
    CONFIG_AHBOT_PRICING_MIN_REAGENT,
    CONFIG_AHBOT_PRICING_MIN_PROJECTILE,
    CONFIG_AHBOT_PRICING_MIN_TRADEGOOD,
    CONFIG_AHBOT_PRICING_MIN_RECIPE,
    CONFIG_AHBOT_PRICING_MIN_QUIVER,
    CONFIG_AHBOT_PRICING_MIN_QUEST,
    CONFIG_AHBOT_PRICING_MIN_KEY,
    CONFIG_AHBOT_PRICING_MIN_MISC,
    CONFIG_AHBOT_PRICING_MIN_GLYPH,

    // === NEW: Subclass priorities for Trade Goods ===
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_CLOTH_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_LEATHER_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_METAL_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_MEAT_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_HERB_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_ELEMENTAL_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_ENCHANTING_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_JEWELCRAFTING_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_PARTS_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_DEVICES_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_EXPLOSIVES_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_MATERIALS_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_OTHER_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_ARMOR_ENCHANT_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_TRADEGOOD_WEAPON_ENCHANT_PRIORITY,

    // === NEW: Subclass priorities for Consumables ===
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_POTION_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_ELIXIR_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_FLASK_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_SCROLL_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_FOOD_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_BANDAGE_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_ITEM_ENHANCEMENT_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_CONSUMABLE_OTHER_PRIORITY,

    // === NEW: Subclass priorities for Gems ===
    CONFIG_AHBOT_SUBCLASS_GEM_RED_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_BLUE_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_YELLOW_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_PURPLE_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_GREEN_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_ORANGE_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_META_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_SIMPLE_PRIORITY,
    CONFIG_AHBOT_SUBCLASS_GEM_PRISMATIC_PRIORITY,
...
enum AuctionBotConfigBoolValues
{
    ...
    // === NEW: Advanced feature toggles ===
    CONFIG_AHBOT_PRICING_USE_DROP_TIER,
    CONFIG_AHBOT_PRICING_USE_LOGARITHMIC,
    CONFIG_AHBOT_FILTER_RECIPE_PRODUCED,
    CONFIG_AHBOT_FILTER_QUEST_REWARD,
    CONFIG_AHBOT_USE_WEIGHTED_SELECTION,
    CONFIG_AHBOT_USE_ADVANCED_PRICING,
...
enum AuctionBotConfigFloatValues
{
    ...
    CONFIG_AHBOT_PRICING_VARIATION_MIN,
    CONFIG_AHBOT_PRICING_VARIATION_MAX,

    // === NEW: Drop tier price multipliers ===
    CONFIG_AHBOT_TIER_PRICE_50_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_10_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_5_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_2_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_1_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_5_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_2_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_1_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_05_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_02_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_01_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_0_005_PERCENT,
    CONFIG_AHBOT_TIER_PRICE_NO_DROP,

    // === NEW: Logarithmic pricing multipliers ===
    CONFIG_AHBOT_LOG_MULTIPLIER_POTION,
    CONFIG_AHBOT_LOG_MULTIPLIER_ELIXIR,
    CONFIG_AHBOT_LOG_MULTIPLIER_FLASK,
    CONFIG_AHBOT_LOG_MULTIPLIER_SCROLL,
    CONFIG_AHBOT_LOG_MULTIPLIER_FOOD,
    CONFIG_AHBOT_LOG_MULTIPLIER_BANDAGE,
    CONFIG_AHBOT_LOG_MULTIPLIER_CLOTH,
    CONFIG_AHBOT_LOG_MULTIPLIER_LEATHER,
    CONFIG_AHBOT_LOG_MULTIPLIER_METAL,
    CONFIG_AHBOT_LOG_MULTIPLIER_HERB,
    CONFIG_AHBOT_LOG_MULTIPLIER_ELEMENTAL,
    CONFIG_AHBOT_LOG_MULTIPLIER_ENCHANTING,
    CONFIG_AHBOT_LOG_MULTIPLIER_JEWELCRAFTING,
    CONFIG_AHBOT_LOG_MULTIPLIER_GEM,
...
public:
    ...
    // === NEW: Helper methods for new configs ===
    uint32 GetDropTierListWeight(uint8 tier) const;
    float GetDropTierPriceMultiplier(uint8 tier) const;
...
// Extended status info including tier breakdown
struct AuctionHouseBotExtendedStatusInfo
{
    uint32 ItemsCount;
    std::unordered_map<AuctionQuality, uint32> QualityInfo;
    std::unordered_map<uint8, uint32> TierInfo;  // Drop tier breakdown
};
...
public:
    ...
    void PrepareExtendedStatusInfos(std::unordered_map<AuctionHouseType, AuctionHouseBotExtendedStatusInfo>& statusInfo);
    void ForceUpdateCycle();
    void EmptyAuctions(AuctionHouseType houseType);
